...
// use app\vendor1\HTML2PDF\src\Html2Pdf;
// use app\vendor1\HTML2PDF\src\Exception\Html2PdfException;
// use app\vendor1\HTML2PDF\src\Exception\ExceptionFormatter;
use kartik\mpdf\Pdf;
    ...
    public function actionPaying(){
     ...
     /* public function actionChecking(){
      ...
      public function actionPay(){
        ...
        $chk = new Checksum();
        // $privatekey =$chk->encrypt($config_data[0]['AIRPAY_USERNAME'].":|:".$config_data[0]['AIRPAY_PASSWORD'], $config_data[0]['AIRPAY_SECRET_KEY']);
        $privatekey =$chk->encrypt("1919255:|:698kL4l7",'4dBE183R725a9');
